  ...
  return (
    <div className="bg-[#F3F8FF] min-h-screen">
      <div className="grid grid-cols-11">
        ...
        <div className="col-start-1 sm:col-start-3 col-end-12 min-w-full ">
          <div className="p-10 col-start-3 sm:col-start-3 mt-15 min-w-full min-h-[100%]  flex flex-row justify-between flex-grow flex-wrap  grid-flow-row gap-10 mx-auto bg-blue-100">
            <div className="min-w-[45%]  bg-white">
              <ChartLine />
            </div>
            <div className="min-w-[45%]  bg-white">
              <ChartBar />
